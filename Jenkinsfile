pipeline {
    ...
    environment {
        ...
        AWS_DEFAULT_REGION = 'us-west-1' //This will stay the same since your AWS_DEFAULT_REGION name is the same 
        AWS_ACCOUNT_ID = '724772049461' //change this to your AWS_ACCOUNT_ID
